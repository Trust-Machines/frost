...
use crate::frost::{Party, PolyCommitment, PublicNonce, SignatureAggregator, SignatureShare};

use hashbrown::HashMap;

pub struct Stats {
    pub total_compute_secret_time: u128,
    pub total_party_sig_time: u128,
    pub total_sig_time: u128,
    pub num_sigs: usize,
    pub total_secret_distribution_bandwidth: usize,
    pub total_nonce_distribution_bandwidth: usize,
    pub total_sig_bandwidth: usize,
}

#[allow(non_snake_case)]
pub fn simulate(N: usize, T: usize) -> Stats {
    let num_sigs = 7;
    let num_nonces = 5;
